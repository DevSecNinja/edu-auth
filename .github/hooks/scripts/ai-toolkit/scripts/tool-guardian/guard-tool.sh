...
# etc.) before the AI coding agent executes them.
#
# Adapted from github/awesome-copilot (hooks/tool-guardian, MIT License) and
# repackaged as a native APM hook primitive. Source pinned at commit
# 3e36d367091a1e67b77974cade6f1aa48bc77a81.
#
